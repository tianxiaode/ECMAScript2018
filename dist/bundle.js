...
var _dom = require('./handlers/dom');

var _dom2 = require('./mixins/dom');

var _style = require('./handlers/style');

var _style2 = require('./mixins/style');

var _class = require('./handlers/class');

var _class2 = require('./mixins/class');

var _attribute = require('./handlers/attribute');

var _attribute2 = require('./mixins/attribute');

var _event = require('./event');

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

window.EventObserver = _event.EventObserver;
...
var Element = exports.Element = function () {
    function Element(selector) {
        ...
        me.domHandler = new _dom.Dom();
        me.styleHandler = new _style.Style();
        me.clsHandler = new _class.Cls();
        me.attributeHandler = new _attribute.Attribute();
    }
...
Object.assign(Element.prototype, _dom2.Dom, _style2.Style, _class2.Cls, _attribute2.Attribute);
//Object.assign(Element.prototype,StyleMixin);
//Object.assign(Element.prototype,ClsMixin);
//Object.assign(Element.prototype,AttributeMixin);

},{"./event":328,"./handlers/attribute":329,"./handlers/class":330,"./handlers/dom":331,"./handlers/style":332,"./mixins/attribute":334,"./mixins/class":335,"./mixins/dom":336,"./mixins/style":337}],328:[function(require,module,exports){
"use strict";
...
var EventObserver = exports.EventObserver = new (function () {
    function _class() {
    ...
    _createClass(_class, [{
        key: "bindEvent",
        value: function bindEvent(event, callback, targetElement) {
            var me = this,
                events = me.events,
        ...
        key: "unbindEvent",
        value: function unbindEvent(event, targetElement) {
            var me = this,
                events = me.events,
                targetEvents = events.get(targetElement) || {};
            if (targetEvents[event]) {
...
var Attribute = exports.Attribute = function () {
    ...
    _createClass(Attribute, [{
        key: 'addAttribute',
        value: function addAttribute(attribute, value, targetElement) {
            targetElement.setAttribute(attribute, value + '');
        }
    }, {
        key: 'removeAttribute',
        value: function removeAttribute(attribute, targetElement) {
            targetElement.removeAttribute(attribute);
        }
    }, {
        key: 'getAttribute',
        value: function getAttribute(attribute, targetElement) {
...
var Cls = exports.Cls = function () {
    ...
    _createClass(Cls, [{
        key: 'replaceCls',
        value: function replaceCls(value, targetElement, op) {
            var me = this,
            ...
            targetElement.className = [].concat(_toConsumableArray(clsSet)).join(' ');
        }
    }]);
...
var Dom = function () {
    ...
    _createClass(Dom, [{
        key: "html",
        value: function html(_html, targetElement) {
            targetElement.innerHTML = _html;
        }
    }, {
        key: "append",
        value: function append(child, targetElement) {
            var originHtml = targetElement.innerHTML;
...
var Style = function () {
    ...
    _createClass(Style, [{
        key: 'style',
        value: function style(_style, value, targetElement) {
            if ((typeof _style === 'undefined' ? 'undefined' : _typeof(_style)) === 'object') {
                ...
                try {
                    for (var _iterator = Object.entries(_style)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        ...
                        targetElement.style.setProperty(prop, _value);
                    }
                } catch (err) {
                    _didIteratorError = true;
                    _iteratorError = err;
                ...
                targetElement.style.setProperty(_style, value);
            }
        }
    }, {
        key: 'size',
        value: function size(width, height, targetElement) {
        ...
        key: 'hide',
        value: function hide(targetElement) {
...
window.$ = function (selector) {
    return new _element.Element(selector);
};
...
},{"./element":327,"babel-polyfill":1}],334:[function(require,module,exports){
'use strict';
...
var Cls = exports.Cls = {
    addCls: function addCls(value) {
        var me = this;
        me.clsHandler.replaceCls(value, me.dom, 'add');
        return me;
    },
    removeCls: function removeCls(value) {
        var me = this;
...
var Dom = exports.Dom = {
    html: function html(_html) {
        var me = this;
        me.domHandler.html(_html, me.dom);
        return me;
    },
